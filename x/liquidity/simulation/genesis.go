...
func GenMinInitDepositAmount(r *rand.Rand) sdkmath.Int {
...
func GenInitPoolCoinMintAmount(r *rand.Rand) sdkmath.Int {
...
func GenMaxReserveCoinAmount(r *rand.Rand) sdkmath.Int {
...
func RandomizedGenState(simState *module.SimulationState) {
	...
	var minInitDepositAmount sdkmath.Int
	simState.AppParams.GetOrGenerate(
	...
	var initPoolCoinMintAmount sdkmath.Int
	simState.AppParams.GetOrGenerate(
	...
	var maxReserveCoinAmount sdkmath.Int
	simState.AppParams.GetOrGenerate(
