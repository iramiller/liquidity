...
func NewLiquidityApp(
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		...
		authtypes.ProtoBaseAccount, maccPerms, "cosmos",
	)
	...
	app.mm.SetOrderMigrations(
		banktypes.ModuleName, authz.ModuleName, capabilitytypes.ModuleName, crisistypes.ModuleName, distrtypes.ModuleName,
		evidencetypes.ModuleName, feegrant.ModuleName, genutiltypes.ModuleName, govtypes.ModuleName, minttypes.ModuleName, liquiditytypes.ModuleName,
		paramstypes.ModuleName, slashingtypes.ModuleName, stakingtypes.ModuleName, upgradetypes.ModuleName, vestingtypes.ModuleName,
